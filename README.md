...
|------|-----------|-------------|
| `project01.py` | **DNS Reconnaissance Tool** | Automates the extraction of DNS records (A, MX, TXT) to map organization infrastructure. |
| `project02.py` | **Subdomain Discovery Engine** | A multi-threaded tool to discover hidden subdomains using dictionary attacks. |
| `project03.py` | **PDF Encryption Utility** | A defensive tool to secure sensitive documents with password-based encryption. |
